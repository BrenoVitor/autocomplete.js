...
function Typeahead(o) {
  ...
  o.appendToBody = !!o.appendToBody;
  o.hint = !!o.hint;

  if (o.hint && o.appendToBody) {
    throw new Error('[autocomplete.js] hint and appendToBody options can\'t be used at the same time');
  }

  this.css = o.css = _.mixin({}, css, o.appendToBody ? css.appendToBody : {});
...
function buildDom(options) {
  ...
  if (!options.appendToBody && $input.css('display') === 'block' && $input.parent().css('display') === 'table') {
  ...
  $wrapper = options.appendToBody
    ? $wrapper.appendTo(document.body).eq(0)
