...
function Dropdown(o) {
  ...
  this.templates = {};
  this.appendToBody = !!o.appendToBody;
  this.css = _.mixin({}, css, o.appendToBody ? css.appendToBody : {});
  ...
  this.$container = o.appendToBody ? this.$wrapper : this.$menu;
  ...
  DOM.element(window).resize(this._redraw.bind(this));
}
...
_.mixin(Dropdown.prototype, EventEmitter, {
  ...
  _redraw: function redraw() {
    if (!this.isOpen || !this.appendToBody) return;
    ...
    var width = outerWidth(this.$input);
    this.$wrapper.css('width', width + 'px');

    var top = this.$input.offset().top + outerHeight(this.$input, true);
    this.$wrapper.css('top', top + 'px');
    top -= this.$wrapper.offset().top - top;
    this.$wrapper.css('top', top + 'px');

    var left = this.$input.offset().left;
    this.$wrapper.css('left', left + 'px');
    left -= this.$wrapper.offset().left - left;
    this.$wrapper.css('left', left + 'px');
